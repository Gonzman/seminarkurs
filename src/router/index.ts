...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      props: (route) => ({
        level: route.params.difficulty
          ? Level[typeof route.params.difficulty === 'string' ? route.params.difficulty.toUpperCase() as keyof typeof Level : Level.EASY] ?? Level.EASY
          : Level.EASY
      }),
    ...
    },
    {
      ...
      props: (route) => {
        const difficultyKey = typeof route.params.difficulty === 'string'
